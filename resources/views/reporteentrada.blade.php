...
<body id="page-top">
      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item"  href="{{asset('altacliente')}}">Clientes</a>
            <a class="collapse-item" href="{{asset('altaempleado')}}">Empleados</a>
            <a class="collapse-item"href="{{asset('altamesa')}}" >Mesas</a>
           <a class="collapse-item" href="{{asset('altazona')}}">Zonas</a>
            <a class="collapse-item" href="{{asset('altaproductos')}}">Productos</a>
      ...
      <li class="nav-item">
        ...
        <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item"  href="{{asset('reporteclientes')}}">Clientes</a>
            <a class="collapse-item" href="{{asset('reporteempleado')}}">Empleados</a>
            <a class="collapse-item" href="{{asset('reportemesa')}}" >Mesas</a>
           <a class="collapse-item" href="{{asset('reportezona')}}">Zonas</a>
            <a class="collapse-item" href="{{asset('reporteproductos')}}">Productos</a>
 ...
 <div class="container">
    ...
    <link rel="stylesheet" href="{{asset('js/css.css')}}">

<script src="http://localhost/kikosfood/js/jquery-1.11.1.min
"></script>


    <div class="container">
        <form method="POST" id="formprod"  enctype="multipart/form-data">
            {{ csrf_field() }}
        ...
        <div id="tablas">
            <table class="table table-striped">
                ...
                <tr><th>ID</th><th>Fecha</th><th>Reporte</th></tr>
                @foreach($entrada as $ent)
                    <tr>
                        <td>{{$ent->idv}}</td>
                        <td>{{$ent->fecha}}</td>
                        <td><a class="btn btn-primary" href="{{route('buscre',$ent->idv)}}">Ver reporte</a> </td>
                    </tr>
        ...
        <script type="text/javascript">
            $(document).ready(function () {
                $('#fecha').on('change',function () {
                    $("#tablas").load('{{url('criterioreporte')}}' + '?' + $(this).closest('form').serialize());
