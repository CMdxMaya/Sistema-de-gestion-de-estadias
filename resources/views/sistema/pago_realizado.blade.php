        ...
        <div class="card o-hidden border-0 shadow-lg my-5">
          <div class="card-body p-0">
            ...
            <div class="row">
              ...
              <div class="col-lg-6 d-none d-lg-block " > <br><br><br><img  width="500px" src="{{asset('carritocompras/pago.jpg')}}"></div>


              <div class="col-lg-6">
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-4">Gracias por su pago. Su pago se ha completado y le hemos enviado un recibo de su compra por correo electrónico. Para ver los detalles de la transacción, inicie sesión en su cuenta PayPal</h1>
                  </div>
                  <form class="user">
