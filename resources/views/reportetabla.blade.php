...
<div class="container">
    <div class="form-group">
        ...
        <div class="col-xs-12 col-lg-6">
            ...
            <input type="text" class="form-control" id="idv" value="{{$ventadetalles[0]->idv}}" name="idv" readonly>
        </div>
 <div class="col-xs-12 col-lg-6">
            <label>Fecha</label>
            <input type="text" class="form-control" id="idv" value="{{$ventadetalles[0]->fecha}}" name="idv" readonly>
        </div>
...
<table class="table table-striped">
    ...
    @foreach($ventadetalles as $ven)
        ...
        <tr>
            ...
            <td>{{$ven->nombrepro}}</td>
                        ...
                        <td>{{$ven->observaciones}}</td>


                                                  <td>{{$ven->costo * $ven->cantidad}}</td>
    ...
    @endforeach
        ...
        @foreach($resultado2 as $tota)


    <tr>
        <td colspan="3"><h2 class="h2">Total</h2></td>
        <td colspan="5"><h2 class="h2"> {{$tota->totalr}} </h2></td>
    </tr>
