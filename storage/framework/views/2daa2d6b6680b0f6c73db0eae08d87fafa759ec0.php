  ...
  <body>
	...
	<tr><th>ID</th><!--<th>Imagen</th>--><th>Nombre Alumno</th><th>Descripcion Trabajo</th><th>Matricula</th><th>Tutor</th><!--<<td>ID.Producto</td>--><?php if(Session::get('sesiontipo')=="Admin"): ?>
<th>Opciones</th>
<?php endif; ?></tr>
</thead>
