...
<div class="form-group">
		        ...
		        <?php endif; ?> 
		        <div class="form-group">
				<input type="text" class="form-control form-control-user" placeholder="Nombre del Alumno"  name="nombrepro" value="<?php echo e(old('nombrepro')); ?>">
				</div>
		        ...
		        <?php endif; ?> 
		        <div class="form-group">
				 <input type="text" class="form-control form-control-user" placeholder="Matricula del estudiante"  name="costo" value="<?php echo e(old('costo')); ?>">
				</div>
