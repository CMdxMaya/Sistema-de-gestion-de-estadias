...
<br>
	...
	<?php if($errors->first('zona')): ?> 
		...
		<?php endif; ?>
			...
			<input  class="form-control form-control-user" placeholder="Ingrese nombre de la empresa" type = 'text' name = 'zona' value="<?php echo e(old('zona')); ?>">
	<br>
	<?php if($errors->first('descripcion')): ?> 
		<i> <?php echo e($errors->first('descripcion')); ?> </i> 
		<?php endif; ?>	
		<input   class="form-control form-control-user" placeholder="Ingrese Descripcion" type = 'text' name = 'descripcion' value="<?php echo e(old('descripcion')); ?>">
