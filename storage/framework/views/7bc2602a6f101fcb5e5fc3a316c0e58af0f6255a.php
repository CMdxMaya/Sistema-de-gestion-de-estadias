      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item"  href="<?php echo e(asset('altacliente')); ?>">Alumnos</a>
            <a class="collapse-item" href="<?php echo e(asset('altaempleado')); ?>">Profesores</a>
            <!--<a class="collapse-item"href="<?php echo e(asset('altamesa')); ?>" >Mesa</a>-->
           <a class="collapse-item" href="<?php echo e(asset('altazona')); ?>">Empresas</a>

            <a class="collapse-item" href="<?php echo e(asset('altaproductos')); ?>">Evidencias</a>
      ...
      <li class="nav-item">
        ...
        <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item"  href="<?php echo e(asset('reporteclientes')); ?>">Alumnos</a>
            <a class="collapse-item" href="<?php echo e(asset('reporteempleado')); ?>">Profesores</a>
          <!--  <a class="collapse-item" href="<?php echo e(asset('reportemesa')); ?>" >Mesas</a>-->
           <a class="collapse-item" href="<?php echo e(asset('reportezona')); ?>">Empresas</a>
            <a class="collapse-item" href="<?php echo e(asset('reporteproductos')); ?>">Evidencias</a>
